        ...
        if (!inputFolder.exists) {
            ...
            if (items.length === 0) {
                ...
                function flushReport(force) {
                    if (!force && reportDirtyCount < REPORT_FLUSH_INTERVAL) return;
                ...
                function updateReportRow(index, row) {
                    ...
                    appendManagedLog(logState, formatLogRow(index + 1, row));
                ...
                if (shouldProcess) {
                    ...
                    logState = initManagedLog(new File(logPath), buildLogHeader(reportMeta));
                    logPath = logState.path || logPath;
                    logWriteWarning = logState.warning || "";
                    logWriteError = logState.error || "";

                    reportDirtyCount = REPORT_FLUSH_INTERVAL;
                    flushReport(true);
